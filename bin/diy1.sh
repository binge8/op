...
#删除重名软件包
rm -rf feeds/luci/applications/luci-app-dockerman feeds/luci/applications/luci-app-pushbot package/openwrt-packages/small-package/luci-app-passwall2 package/openwrt-packages/small-package/ikoolproxy
#设置环境变量
